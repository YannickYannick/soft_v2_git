...
class CommunicationPicoscope(threading.Thread):
    def __init__(self, master):
        ...
        self.master = master
        self.initialisation_picoscope_9001 = 0
        self.picoscope_selected = ""
    ...
    def initialisation_picoscope_9000(self):
        print("initiatisation picoscope 9000")
        ############ MODEL #############
        ...
        self.picoscope_selected = "picoscope_9000"
        self.start()

    
    def run(self):
        for i in range(100):
            if self.picoscope_selected == "picoscope_9000":
                ...
                self.dataa = self.strdata.astype(np.float)
                self.data = self.dataa[:512]
                
            
            elif self.picoscope_selected == "picoscope_2000":
                self.ps.runBlock()
                self.ps.waitReady()
            ...
            time.sleep(0.5) #1 second = un peu lent
